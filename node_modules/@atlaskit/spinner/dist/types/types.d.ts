export declare type PresetSize = 'xsmall' | 'small' | 'medium' | 'large' | 'xlarge';
export declare type Size = PresetSize | number;
export declare type Appearance = 'inherit' | 'invert';
